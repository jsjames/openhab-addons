...
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_DEV_LAT;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_DEV_LONG;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_IP_ADDRESS;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_IP_DNS1;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_IP_DNS2;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_IP_GW;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_IP_MASK;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_MODEL;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_NAME;
import static org.openhab.binding.rachio.internal.RachioBindingConstants.PROPERTY_WIFI_RSSI;
...
import org.openhab.binding.rachio.internal.api.dto.RachioApiZone.RachioApiZone;
import org.openhab.binding.rachio.internal.api.dto.RachioDeviceGsonDTO.RachioCloudDevice;
import org.openhab.binding.rachio.internal.api.dto.RachioDeviceGsonDTO.RachioCloudNetworkSettings;
...
public class RachioDevice extends RachioCloudDevice {
    ...
    private Map<String, RachioZone> zoneList = new HashMap<String, RachioZone>();
    @Nullable
    private RachioControllerHandler thingHandler = null;
    @Nullable
        ...
        try {
            ...
            if (!device.deleted) {
                ...
                for (int i = 0; i < device.zones.size(); i++) {
                    RachioApiZone zone = device.zones.get(i);
     ...
     * @param deviceHandler
     */
    public void setThingHandler(RachioControllerHandler deviceHandler) {
     ...
     */
    @Nullable
    public RachioControllerHandler getThingHandler() {
        return thingHandler;
    }
