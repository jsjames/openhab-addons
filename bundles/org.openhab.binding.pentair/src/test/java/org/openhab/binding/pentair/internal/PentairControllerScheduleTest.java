...
public class PentairControllerScheduleTest {
    ...
    public void parseTest() {
        ...
        PentairPacket p = new PentairPacket(packets[0]);
        ...
        PentairPacket p2 = new PentairPacket(packets[1]);
        pcs.parsePacket(p2);
        ...
        PentairPacket p3 = new PentairPacket(packets[2]);
        pcs.parsePacket(p3);
        ...
        PentairPacket p4 = new PentairPacket(packets[3]);
        pcs.parsePacket(p4);
